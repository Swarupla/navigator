...
var navdata = [
  ...
  },
  {
    ...
    "flagleft": "false",
    "flagright": "false",
    "content": "Change and Continuous Reinvention",
    "boxcontent": "1",
    "key": "5",
  },
];
...
$(".navigation-control.left").click(function () {
  ...
  $('.screen1-content-inner5').addClass('active');
  setTimeout(() => {
    $('.screen1-content-inner5').addClass('active');
  }, 500);
  // currentIndexLeft++; //1
...
$('.mainflexclick').click(function () {
  ...
  if (blockatr == 'click1') {
    intervalId = setInterval(increaseCounters, 500);
  }
...
$('.tab-change').click(function () {
  ...
  $('.chartnewgraph').removeClass('active');
  setTimeout(() => {
    $('.chartnewgraph').addClass('active');
  }, 500);
});
$('.inner-tab-click li').click(function () {
  $('.chartnewgraph').removeClass('active');
  setTimeout(() => {
    $('.chartnewgraph').addClass('active');
  }, 500);
...
$('.btn-panel').click(function () {
  var getnewid = $(this).attr('data-id');
  $('.btn-panel').removeClass('active');
  $('.graphtemplate').removeClass('active');
  $('.btn-panel[data-id=' + getnewid + ']').addClass('active');
  $('.graphtemplate[data-id=' + getnewid + ']').addClass('active');
  $('.graphtemplate').removeClass('activeanimations');
  setTimeout(() => {
    $('.graphtemplate').addClass('activeanimations');
  }, 500);
  $('.chartnewgraph').removeClass('active');
  setTimeout(() => {
    $('.chartnewgraph').addClass('active');
